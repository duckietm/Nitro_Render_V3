...
export interface IRoomCreator
{
    ...
    rollRoomObjectFloor(roomId: number, objectId: number, location: IVector3D, targetLocation: IVector3D, duration?: number, direction?: IVector3D, elapsed?: number, anchorObject?: IRoomObjectController, anchorOffset?: IVector3D, animationEffect?: number, gravityIntensity?: number): void;
