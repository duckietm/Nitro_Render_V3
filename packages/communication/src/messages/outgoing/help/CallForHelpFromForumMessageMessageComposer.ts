...
export class CallForHelpFromForumMessageMessageComposer implements IMessageComposer<ConstructorParameters<typeof CallForHelpFromForumMessageMessageComposer>>
{
    ...
    constructor(groupId: number, threadId: number, messageId: number, cfhTopic: number, message: string, reporterName: string = '', reporterEmail: string = '')
    {
        this._data = [groupId, threadId, messageId, cfhTopic, message, reporterName, reporterEmail];
    }
