...
import { UiSettingsDataEvent } from './messages/incoming/uisettings/UiSettingsDataEvent';
import { UiSettingsSaveComposer } from './messages/outgoing/uisettings/UiSettingsSaveComposer';
import { UiSettingsLoadComposer } from './messages/outgoing/uisettings/UiSettingsLoadComposer';
...
export class NitroMessages implements IMessageConfiguration
{
    ...
    private registerEvents(): void
    {
        ...
        // UI Settings
        this._events.set(IncomingHeader.UI_SETTINGS_DATA, UiSettingsDataEvent);
    }
    ...
    private registerComposers(): void
    {
        ...
        // UI Settings
        this._composers.set(OutgoingHeader.UI_SETTINGS_SAVE, UiSettingsSaveComposer);
        this._composers.set(OutgoingHeader.UI_SETTINGS_LOAD, UiSettingsLoadComposer);
    }
